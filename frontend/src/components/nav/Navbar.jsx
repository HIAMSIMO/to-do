    ...
    <header>
      <div className={classes.userInfo}>
        ...
        <div>
          ...
          {user.role === 'admin' && (
          <>
            <Link to="/projects" className={classes.editBtn}>Projects</Link>
            <Link to="/overview" className={classes.editBtn}>Overview</Link>
            <Link to="/addUser" className={classes.editBtn}>Add User</Link>
          </>
          )}
        </div>
      </div>
